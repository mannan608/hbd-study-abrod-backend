@php
    ...
    $inputCls = 'w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 transition duration-150 focus:border-brand-500 focus:outline-none focus:ring-4 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white dark:placeholder-gray-500 dark:focus:border-brand-500';
    $labelCls = 'mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300';
    $iconBtnDanger = 'inline-flex h-9 w-9 items-center justify-center rounded-lg text-gray-400 transition hover:bg-red-50 hover:text-red-600 focus:outline-none focus:ring-2 focus:ring-red-500/30 dark:hover:bg-red-500/10 dark:hover:text-red-400';
    $addBtnCls = 'flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-gray-300 px-4 py-3 text-sm font-medium text-gray-500 transition duration-150 hover:border-brand-400 hover:bg-brand-50/50 hover:text-brand-600 focus:outline-none focus:ring-4 focus:ring-brand-500/10 dark:border-gray-700 dark:text-gray-400 dark:hover:border-brand-500/50 dark:hover:bg-brand-500/5 dark:hover:text-brand-400';
@endphp
    ...
    <div class="space-y-6 lg:col-span-8">
        ...
        <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="flex items-start gap-4 border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">Core details that define your event and how it appears to visitors.</p>
                </div>
            </div>
        ...
        <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900"
            ...
            <div class="p-6">
                ...
                <div class="mt-6 flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50/60 px-4 py-3.5 dark:border-gray-700 dark:bg-white/[0.02]">
                    <div class="flex items-center gap-3">
                        <svg class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m-8.716 6.747A9.004 9.004 0 0112 3m0 18a9.004 9.004 0 01-8.716-6.747M3.284 14.253A8.967 8.967 0 003 12m18 0a8.967 8.967 0 00-.284 2.253M3.284 9.747A8.967 8.967 0 013 12"/>
                        </svg>
                        <div>
                            <p class="text-sm font-medium text-gray-700 dark:text-gray-200">Online event</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400">Enable if this event happens virtually</p>
                        </div>
                    </div>
                    <input type="hidden" name="is_online" value="0">
                    <label class="relative inline-flex cursor-pointer items-center">
                        <input type="checkbox" name="is_online" value="1" x-model="isOnline" class="peer sr-only">
                ...
                <div x-show="isOnline" x-cloak
                    ...
                    class="mt-5">
                    <x-form.input-text name="meeting_link" label="Meeting Link"
        ...
        <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900"
            ...
            <div class="flex items-start gap-4 border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                ...
                <div class="flex-1">
                    ...
                    <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">Add one or more sessions with their own dates and venues.</p>
                </div>
            ...
            <div class="space-y-4 p-6">
                <template x-for="(item, index) in items" :key="index">
                    <div class="rounded-xl border border-gray-200 bg-gray-50/50 p-5 transition dark:border-gray-700 dark:bg-white/[0.02]">
                        <div class="mb-4 flex items-center justify-between">
                            <span class="inline-flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-gray-200">
                                <span class="flex h-6 w-6 items-center justify-center rounded-md bg-brand-600 text-xs font-bold text-white" x-text="index + 1"></span>
                                Session
                            </span>
                            <button type="button" x-show="items.length > 1" @click="remove(index)"
                                class="{{ $iconBtnDanger }}" title="Remove session">
                                <svg class="h-4.5 w-4.5 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
        ...
        <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900"
            ...
            <div class="flex items-start gap-4 border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">Organizations supporting or running this event.</p>
                </div>
            </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <template x-if="item.logo_url">
                                    <div class="mb-2 flex items-center gap-3 rounded-lg border border-gray-200 bg-white px-3 py-2 dark:border-gray-700 dark:bg-gray-900">
                                        <img :src="item.logo_url" alt="Logo" class="h-9 rounded object-contain">
                                        <span class="text-xs text-gray-500 dark:text-gray-400">Current logo — choose a file to replace</span>
        ...
        <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="flex items-start gap-4 border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">Photos that showcase the event atmosphere.</p>
                </div>
            </div>
                ...
                @if($isEdit && !empty($event->gallery_images))
                    <div class="mb-5 grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
                        @foreach($event->gallery_images as $image)
                            <div class="group relative overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700">
                                <img src="{{ asset($image) }}" class="h-24 w-full object-cover transition duration-200 group-hover:scale-105">
                                <label class="absolute inset-x-0 bottom-0 flex cursor-pointer items-center justify-center gap-1.5 bg-black/60 py-1.5 text-xs font-medium text-white backdrop-blur-sm transition hover:bg-red-600/80">
                                    <input type="checkbox" name="remove_gallery_images[]" value="{{ $image }}" class="h-3.5 w-3.5 rounded border-white/40 bg-transparent text-red-500 focus:ring-0">
                                    Remove
                                </label>
                            </div>
                        @endforeach
        ...
        <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="flex items-start gap-4 border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">Contact info, map link, and tags for discoverability.</p>
                </div>
            </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <x-form.input-text name="google_map_link" label="Google Map Link" placeholder="https://maps.google.com/..."
        ...
        <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900"
            ...
            <div class="flex items-start gap-4 border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">What attendees will gain from this event.</p>
                </div>
            </div>
            ...
            <div class="p-6">
                <div class="space-y-3">
                    <template x-for="(item, index) in items" :key="index">
                        <div class="flex items-center gap-2">
                            <div class="relative flex-1">
                                <span class="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-emerald-500">
                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/>
                                    </svg>
                                </span>
                                <input type="text" :name="`benefits[${index}]`" x-model="items[index]"
                                    placeholder="e.g. Certificate of participation" class="{{ $inputCls }} pl-10">
                            </div>
                            <button type="button" x-show="items.length > 1" @click="remove(index)"
        ...
        <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900"
            ...
            <div class="flex items-start gap-4 border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">Services provided during or after the event.</p>
                </div>
            </div>
        ...
        <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900"
            ...
            <div class="flex items-start gap-4 border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">Answer common questions to reduce attendee friction.</p>
                </div>
            </div>
                ...
                <div class="space-y-5 p-6">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">Highlight on homepage & listings</p>
                        </div>

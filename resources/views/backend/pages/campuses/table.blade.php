@php
    ...
    $tableRowData = $collection->map(function ($campus) {
        return [
            'id' => $campus->id,
            'name' => $campus->name,
            'slug' => $campus->slug,
        ...
        <div x-show="showDeleteModal" x-cloak class="fixed inset-0 z-[99999]">
            ...
            <div class="absolute inset-0 flex items-center justify-center p-4">
                <div class="w-full max-w-md rounded-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-xl">
                    <div class="p-5">
                        <div class="text-base font-semibold text-neutral-800 dark:text-white/90">Delete Campus?</div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-neutral-50 dark:bg-white/[0.02] border-b border-neutral-100 dark:border-white/[0.05]">
                        <tr>
                            ...
                            <th class="px-5 py-4 text-xs font-medium text-neutral-500 uppercase tracking-wider">Mail</th>
                            <th class="px-5 py-4 text-xs font-medium text-neutral-500 uppercase tracking-wider">Address</th>
                        ...
                        <template x-for="row in tableRowData" :key="row.id">
                            <tr class="hover:bg-neutral-50/50 dark:hover:bg-white/[0.01] transition-colors">
                                ...
                                <td class="px-5 py-4 text-sm text-neutral-500 dark:text-neutral-400">
                                    <span x-text="row.city"></span>, <span x-text="row.address"></span>
                                </td>
                                ...
                                <td class="px-5 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        <a :href="campusBaseUrl + '/' + row.id + '/edit'" class="p-2 text-neutral-500 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-500/10 rounded-lg transition-all">

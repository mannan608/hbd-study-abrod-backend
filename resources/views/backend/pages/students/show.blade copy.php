        ...
        <main class="flex-1 space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
                ...
                <div class="space-y-6 lg:col-span-8">
                    {{-- Tab Menu --}}
            <section class="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 shadow-xs">
                <div class="flex flex-wrap items-center gap-x-3 gap-y-2">
                    <button type="button"
                        class="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-700">

    ...
    <section class="py-8 md:py-12 lg:py-14 ">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="flex flex-col items-center justify-center mb-4 md:mb-6 lg:mb-8">
                ...
                <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-neutral-900 tracking-tight text-center">Welcome to
                   HBD Services</h1>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-0">
                ...
                <div class="content flex flex-col gap-3 md:gap-4 lg:gap-6">
                    <p class="lg:text-base text-sm text-neutral-500">Welcome to HBD Services Australia, a leading
                    ...
                    <p class="lg:text-base text-sm text-neutral-500">
                        ...
                        At HBD Services Australia, we believe in fostering a supportive and inclusive community that
            ...
            <div class="flex flex-col gap-3 md:gap-4 lg:gap-6 mt-3 md:mt-4 lg:mt-6">
                ...
                <p class="lg:text-base text-sm text-neutral-500">At HBD Services Australia, we prioritise the holistic
                ...
                <p class="lg:text-base text-sm text-neutral-500">
                    ...
                    Choose HBD Services Australia for an education that will empower you to shape a brighter future.
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
            <div class="">
                <div class="flex flex-col items-center justify-center">
                    <div class="h-1.5 w-14 bg-brand-500 rounded-full mb-3"></div>
                    <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-neutral-900 tracking-tight">Our Courses</h1>
                    <p class="text-sm lg:text-base text-neutral-600 text-center mt-3">We offer a range of industry-relevant

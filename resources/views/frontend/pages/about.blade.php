...
@section('content')
    <!-- Main Container -->  
        ...
        <!-- About Us Section -->
        <section class="relative overflow-hidden py-12 sm:py-18 lg:py-20">
        ...
        <section class="">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <header
                    class="mx-auto max-w-2xl px-4 py-12 text-center  translate-y-10 transition-all duration-1000 ease-out">
                    <div
        ...
        <section class="my-16 md:my-20 lg:my-24">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-brand-900 text-white rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-xl">
        ...
        <section class="my-16 md:my-20 lg:my-24">
            ...
            <div class="max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8 bg-white p-8 lg:p-12 rounded-3xl border border-slate-100  space-y-10">

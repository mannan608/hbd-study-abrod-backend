<a href="#" class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
    ...
    <div class="flex items-start gap-4">
        <!-- Logo Badge -->
        <div
            class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[#082f3a] text-base font-bold text-white">
            UM
        </div>
    ...
    <div class="grid grid-cols-3 gap-y-5 gap-x-4">
        ...
        <div>
            ...
            <p class="text-base font-semibold text-slate-900">A$48,000</p>
        </div>
        <div>
            <p class="text-xs text-slate-500">Total fee</p>
            <p class="text-base font-semibold text-slate-900">A$96,000</p>
        </div>
        <div>
            <p class="text-xs text-slate-500">Duration</p>
            <p class="inline-flex items-center gap-1.5 text-base font-semibold text-slate-900">
        ...
        <!-- Row 2 -->
        <div>
            <p class="text-xs text-slate-500">English score</p>
            <p class="text-base font-semibold text-slate-900">IELTS 6.5 · PTE 58</p>
        </div>
        <div>
            <p class="text-xs text-slate-500">Next intake</p>
            <p class="inline-flex items-center gap-1.5 text-base font-semibold text-slate-900">
                <svg class="h-4 w-4 text-slate-700" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                    stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div>
            ...
            <p class="text-base font-semibold text-slate-900">A$100</p>
        </div>
    </div>

 {{-- <!-- Card 1: Prisha Sharma -->
    <div class="flex flex-col justify-between rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
      <div>
        <div class="flex items-start justify-between">
          <div class="flex items-center gap-3">
            <img class="h-12 w-12 rounded-full object-cover" src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150" alt="Prisha Sharma" />
            <div>
              <h3 class="font-bold text-slate-900">Prisha Sharma</h3>
              <p class="text-sm text-slate-500">Visa &amp; GTE Specialist</p>
            </div>
          </div>
          <span class="text-sm font-semibold text-brand-600 bg-brand-25 py-1 px-2 rounded-full">8+ Yrs Exp</span>
        </div>
        ...
        <div class="mt-4 flex items-center gap-1.5 text-sm text-slate-500">
          ...
          <span><strong class="font-semibold text-slate-700">Languages :</strong> Hindi, English</span>
        </div>
        <div class="mt-4 flex items-center gap-1.5 text-sm text-slate-500">
          ...
          <span><strong class="font-semibold text-slate-700">Location :</strong> Bangladesh Dhaka</span>
        </div>
      </div>

      <div class="flex items-center justify-center">
        <button class="mt-6 w-fit inline-flex items-center justify-center gap-2 rounded-xl bg-brand-100 px-4 py-2.5 text-sm font-bold text-brand-700 transition hover:bg-slate-100">
        View Profile &amp; Book
 ...
 <div class="swiper myCounsellerSwiper w-full overflow-hidden py-4">
     <div class="swiper-wrapper">
             ...
             <div class="flex flex-col justify-between rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                 <div>
                     <div class="flex items-start justify-between">
                         ...
                         <span class="text-sm font-semibold text-brand-600 bg-brand-25 py-1 px-2 rounded-full">8+ Yrs
                             Exp</span>
                     </div>
                 ...
                 <div class="flex items-center justify-center">
                     <button
                         class="mt-6 w-fit inline-flex items-center justify-center gap-2 rounded-xl bg-brand-100 px-4 py-2.5 text-sm font-bold text-brand-700 transition hover:bg-slate-100">
                         View Profile &amp; Book
                         <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                             <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
                             <path d="M16 2v4M8 2v4M3 10h18" />
         ...
         <!-- Slide 4 (Recommended for smooth infinite loops) -->
         <div class="swiper-slide h-auto">
             <div class="flex flex-col justify-between rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                 <div>
                     <div class="flex items-start justify-between">

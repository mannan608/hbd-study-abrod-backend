...
@section('content')
    <section class="relative overflow-hidden bg-neutral-25 text-neutral-700">
...
============================================================= --}}
        <div class="pointer-events-none absolute inset-0 overflow-hidden">
            ...
            <div
                class="absolute -top-48 left-1/2 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-brand-100/40 blur-3xl">
            </div>

            <div class="absolute right-[-180px] top-[30%] h-[420px] w-[420px] rounded-full bg-brand-50 blur-3xl"></div>

            <div class="absolute left-[-220px] bottom-[10%] h-[360px] w-[360px] rounded-full bg-brand-25 blur-3xl"></div>

        </div>


        <main class="relative mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-20">
    ...
    ============================================================= --}}
            <header class="mx-auto max-w-4xl text-center">
                ...
                {{-- Badge --}}
                <div
                    class="inline-flex items-center gap-2 rounded-full border border-brand-200 bg-brand-50 px-3.5 py-1.5 text-xs font-semibold text-brand-700 shadow-sm">
                ...
                {{-- Heading --}}
                <h1 class="mt-6 text-4xl font-bold tracking-[-0.04em] text-neutral-950 sm:text-5xl lg:text-6xl">
                ...
                {{-- Description --}}
                <p class="mx-auto mt-5 max-w-2xl text-base leading-7 text-neutral-500 sm:text-lg sm:leading-8">
                ...
                {{-- Meta --}}
                <div
                    class="mt-6 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-xs font-medium text-neutral-500">
        ...
        CONTENT LAYOUT
    ============================================================= --}}
            <div class="mt-12 grid grid-cols-1 gap-8 lg:mt-16 lg:grid-cols-12 lg:gap-12">
                    ...
                    <div class="sticky top-24 space-y-4">
                        ...
                        <div
                            ...
                            <div class="border-t border-neutral-100 bg-neutral-25 p-5">
                                ...
                                <span
                                    class="mb-2 block text-[11px] font-semibold uppercase tracking-wider text-neutral-400">
                                    Key Contact
                                </span>

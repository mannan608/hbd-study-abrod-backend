<section class="relative isolate  w-full min-h-[84vh] flex items-center justify-center overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-5 lg:px-8 py-24 text-center text-white sm:py-32">
            <div
                class="fade-down inline-flex items-center gap-2 px-5 py-2.5 bg-brand-500/10 backdrop-blur-sm rounded-full border border-purple-200/50 mb-8 animate-in fade-in slide-in-from-bottom-3 duration-700">

   <section class="bg-[#f2fbf9] py-16 ">
       <div class="max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8">
           ...
           <div class="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 text-left">
               ...
               <div
                   class="relative group overflow-hidden rounded-2xl bg-[#0b132b] p-6 shadow-md border border-slate-800/80 flex flex-col justify-between h-[380px]">
                   ...
                   <div class="relative z-10 flex items-center justify-between">
                       <span
                           class="rounded-full bg-white px-3 py-1 text-[10px] font-bold text-[#2bb69d] uppercase tracking-wider">
                           High Growth
                       </span>

<section class="py-12 md:py-16 lg:py-20 defer-render">
    {{-- bg-brand-100 text-white py-6 px-8 md:px-12 lg:py-10 lg:px-16 rounded-4xl --}}
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <header
            class="mx-auto max-w-2xl px-4 pb-8 text-center font-sans reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 ease-out">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-brand-500/10 rounded-full mb-6 transition-all duration-700 delay-100">
                ...
                <span class="text-sm font-semibold text-brand-500 uppercase">Your journey, simplified</span>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div
                ...
                <p class="text-xs text-[#b8d3ef] leading-relaxed">
                    Stay on top of application deadlines with reminders and a clear timeline.
                </p>
            </div>
        </div>
    </div>

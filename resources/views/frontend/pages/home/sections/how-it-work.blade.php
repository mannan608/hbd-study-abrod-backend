    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header
            ...
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-brand-500/10 rounded-full mb-6 transition-all duration-700 delay-100"><svg
                    ...
                    class="lucide lucide-zap w-4 h-4 text-brand-500 transition-transform duration-500 group-hover:rotate-12">
                    <path
                        d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z">
                    </path>
                </svg>
                <span class="text-sm font-semibold text-brand-500 uppercase">Simple Application Route</span>
            </div>
            ...
            <p class="mx-auto mt-4 max-w-2xl text-base text-neutral-600 sm:text-lg transition-all duration-700 delay-300">
                From exploration to step-on-campus, our structural flow supports you at every milestones.
            </p>
        </header>
            ...
            <div
                ...
                <div>
                    ...
                    <div class="flex items-center justify-between">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-500 text-white transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 group-hover:shadow-lg">
                            <svg class="h-5 w-5 transition-transform duration-500" fill="none" stroke="currentColor"
                        ...
                        <span
                            class="text-4xl font-extrabold text-brand-500/20 transition-all duration-500 group-hover:text-brand-500/40 group-hover:scale-110">
                            01</span>
                    </div>

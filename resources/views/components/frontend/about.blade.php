        ...
        <div class="flex flex-col items-center justify-center md:block">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 mt-6 md:mt-10">
                ...
                <div class="flex flex-col items-center md:items-start justify-center md:justify-items-start">
                    ...
                    <div>
                        <p class="text-sm lg:text-base text-gray-600 text-center md:text-left">HBD Services work with world class trainers to help
                ...
                <div class="flex flex-col items-center md:items-start justify-center md:justify-items-start">
                    ...
                    <div>
                        <p class="text-sm lg:text-base text-gray-600 text-center md:text-left">HBD Services is registered on the Commonwealth
